...
public class Auth {
    ...
    // use yours
    private static final String CLIENT_ID = "340f9ecd4fba965f66941163bb0969f1fa408ac8815d792d307ac9b01b0448f9";

    // use yours
    private static final String CLIENT_SECRET = "7d676dfb2bd815f8515e12a5bff302db060c66482b2cd8f6a8f0dfa584c9d587";
    ...
    public static final String REDIRECT_URI = "http://sugarac.com";
    ...
    public static String fetchAccessToken(String authCode) throws IOException {
        ...
        RequestBody postBody = new FormBody.Builder()
                ...
                .add(KEY_CODE, authCode) //temporary code
        ...
        Request request = new Request.Builder()
                ...
                .post(postBody)
                .build();
        Response response = client.newCall(request).execute(); //handle I/O Exception
